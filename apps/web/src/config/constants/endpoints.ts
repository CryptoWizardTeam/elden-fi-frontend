...
export const BLOCKS_CLIENT_SEPOLIA = 'https://opbnb-mainnet-graph.nodereal.io/subgraphs/name/pancakeswap/blocks'
// export const BLOCKS_CLIENT_SCROLL = 'https://api.eldensubgraph.online/subgraphs/name/elden/blocks'
// export const BLOCKS_CLIENT_SEPOLIA = 'https://api.eldensubgraph.online/subgraphs/name/elden/blocks'
// export const STABLESWAP_SUBGRAPH_CLIENT = 'https://api.eldensubgraph.online/subgraphs/name/elden/exchange-stableswap'

export const BLOCKS_CLIENT_BASE = 'https://api.studio.thegraph.com/query/48211/base-blocks/version/latest'
export const BLOCKS_CLIENT_BASE_TESTNET = 'https://api.studio.thegraph.com/query/41589/elden-blocks/version/latest'
export const STABLESWAP_SUBGRAPH_CLIENT = 'https://api.studio.thegraph.com/query/41589/elden-stableswap/version/latest'
...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  // [ChainId.SCROLL_SEPOLIA]: 'https://api.thegraph.com/subgraphs/name/cryptolteam/elden-exchange-v2',

  [ChainId.BASE_TESTNET]: 'https://api.studio.thegraph.com/query/41589/elden-positions/version/latest',
  [ChainId.SCROLL]: 'https://api.eldensubgraph.online/subgraphs/name/elden/exchange-v2',
  [ChainId.SCROLL_SEPOLIA]: 'https://api.eldensubgraph.online/subgraphs/name/elden/exchange-v2',
}
...
export const ASSET_CDN = 'https://assets-eldenfi.netlify.app'

export const V3_SUBGRAPH_URLS = {
  [ChainId.ETHEREUM]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-eth',
  [ChainId.SEPOLIA]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-eth',
  ...
  [ChainId.BASE_TESTNET]: 'https://api.studio.thegraph.com/query/41589/elden-v3/version/latest',
  [ChainId.SCROLL]: 'https://api.eldensubgraph.online/subgraphs/name/elden/exchange-v3',
  [ChainId.SCROLL_SEPOLIA]: 'https://api.eldensubgraph.online/subgraphs/name/elden/exchange-v3',
