...
export const DEFAULT_META: PageMeta = {
  title: 'Ggtoro',
  description:
    'Developed on Polygon, Ggtoro is an immutable, decentralized, community-driven DEX with the goal of revolutionizing liquidity solutions. Our platform provides developers and consumers with deep and simply accessible liquidity by providing stable and effective liquidity settings. Providing "Real Yields" to all participants, Ggtoro hopes to establish a new benchmark as the Liquidity Hub of this ecosystem, being the first of its kind on Polygon.',
  image: 'efi/hero.jpeg',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/selden': { basePath: true, title: t('Selden'), image: `${ASSET_CDN}/web/og/hero.jpg` },
