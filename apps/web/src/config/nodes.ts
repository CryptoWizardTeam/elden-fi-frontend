...
import { arbitrum, polygonZkEvm, zkSync, zkSyncTestnet, polygonZkEvmTestnet, arbitrumGoerli, base } from 'wagmi/chains'
import { getNodeRealUrlV2 } from 'utils/nodeReal'
import { opbnbTestnet, linea, opbnb, scroll, scrollSepolia, baseGoerli } from './chains'
